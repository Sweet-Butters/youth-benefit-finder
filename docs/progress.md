...
> **마지막 갱신:** 2026-09-25 06:22 (Claude)
...
| 작업 | 누가 | 하는 일 | 상태 | 시작 |
|---|---|---|---|---|
| 수익 모델 PR | Claude | 소셜벤처(D9), 데이터 원칙(D10), `docs/business-model.md`, 선생님 질문 8~12번 | PR 머지 중 | 2026-09-25 |
...
| 결정 | 아무 말 없으면 | 언제까지 |
|---|---|---|
| **회원가입을 MVP에 넣을지** (사용자는 가입과 데이터 축적을 원함) | D7대로 MVP는 가입 없음. 넣는다면 만 14세 이상만, 최소 수집 | 로드맵 도구 v0 만들기 전 |
